            ...
            TextButton(
              ...
              onPressed: () async {
                FlutterAlibc.taoKeLogin(
                    url: "https://oauth.taobao.com/authorize?response_type=token&client_id=27875713&state=1212&view=wap",
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                var result = FlutterAlibc.taoKeLoginForCode(
                    url: "https://oauth.taobao.com/authorize?response_type=code&client_id=27824900&redirect_uri=http://www.163.com&state=1212&view=web",
                    taokeCallback: (map) {
                      print('淘客登录 ' + json.encode(map));
                    },
                    nativeFailMode: AlibcNativeFailMode.AlibcNativeFailModeJumpH5);
            ...
            TextButton(
              ...
              onPressed: () async {
                FlutterAlibc.openItemDetail(
                    urlParam: UrlParams('597649283190', '1029624918', {}),
            ...
            TextButton(
              ...
              onPressed: () async {
                FlutterAlibc.openCart(
                    urlParams: UrlParams('597649283190', '1029624918', {}),
                    callback: (result) {
                      print(result);
                    });
              },
